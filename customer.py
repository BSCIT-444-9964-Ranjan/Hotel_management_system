...
class Cust_Win:
    def __init__(self,root):
        ...
        lbl_title.place(x=0,y=0,width=1295,height=50)
         ...
         #==========logo===================
        try:
            img2 = Image.open(r"D:\hotel management system\hotel images\logohotel.png")
            img2 = img2.resize((100, 40), Image.LANCZOS)
            self.photoimg2 = ImageTk.PhotoImage(img2)
            lblimg = Label(self.root, image=self.photoimg2, bd=0, relief=RIDGE)
            lblimg.place(x=5, y=2, width=100, height=40)
        except:
            pass # Image nahi mili toh error nahi aayega
        ...
        self.txt_search=StringVar() # Sahi kiya: txt_searrch se txt_search
    ...
    def add_data(self):
        if self.var_mobile.get()=="" or self.var_mother.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="912829",database="management")
    ...
    def search(self):
        ...
        my_cursor=conn.cursor()
        # Sahi search query
        query = "select * from customer where " + str(self.serch_var.get()) + " LIKE '%" + str(self.txt_search.get()) + "%'"
