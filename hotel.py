from tkinter import *
from PIL import Image, ImageTk   # 🔥 IMPORTANT
from customer import Cust_Win
from room import Roombooking
from details import DeatailsRoom

class HotalManagementsSystem:
    def __init__(self, root):
        self.root = root
        self.root.title("Hotel management system")
        self.root.geometry("1550x800+0+0")
       # ============ist img==============
        img1 = Image.open(r"D:\hotel management system\hotel images\hotel1.png")
        ...
        #===========right side image=============
        img3 = Image.open(r"D:\hotel management system\hotel images\slide3.jpg")
...
if __name__ == "__main__":
    root = Tk()
    obj = HotalManagementsSystem(root)
    root.mainloop()